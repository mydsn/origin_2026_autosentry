...
#define CHASSIS_FOLLOW_GIMBAL_BACK_ZERO 249.33f  //底盘跟随云台时的后零点，单位：度
#define CHASSIS_FOLLOW_GIMBAL_RIGHT_ZERO 339.33f // 底盘跟随云台时的右零点
#define CHASSIS_FOLLOW_GIMBAL_LEFT_ZERO 159.33f  // 底盘跟随云台时的左零点
#define CHASSIS_FOLLOW_GIMBAL_ZERO 69.33f       // 底盘跟随云台时的零点，同时也是小陀螺模式下底盘vx(前进)正方向
...
#define STEER_MOTOR_AGGRESIVE_ANGLE_PID_KP 14.0f //过颠簸＋高速小陀螺特化
