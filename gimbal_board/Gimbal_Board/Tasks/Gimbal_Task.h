...
#define BIG_YAW_MOTOR_NAV_ANGLE_PID_MAX_OUT 120.0f
...
#define SMALL_YAW_MOTOR_NORMAL_SPEED_PID_KI 0.06f 
#define SMALL_YAW_MOTOR_NORMAL_SPEED_PID_KD 15.0f

#define SMALL_YAW_MOTOR_RC_SPEED_PID_KP 150.0f // 遥控器控制的时候p改小，防止p轴震 100.0f
#define SMALL_YAW_MOTOR_RC_SPEED_PID_KI 0.06f
...
#define SMALL_YAW_MOTOR_ANGLE_PID_KD 15.0f  //20
#define SMALL_YAW_MOTOR_ANGLE_PID_MAX_OUT 2000.0f
#define SMALL_YAW_MOTOR_ANGLE_PID_MAX_IOUT 100.0f

#define SMALL_YAW_MOTOR_AUTO_AIM_PID_KP 25.0f
#define SMALL_YAW_MOTOR_AUTO_AIM_PID_KI 0.002f
#define SMALL_YAW_MOTOR_AUTO_AIM_PID_KD 15.0f
#define SMALL_YAW_MOTOR_AUTO_AIM_PID_MAX_OUT 2000.0f //2000
...
#define SMALL_YAW_NAV_RUSH_HOME_ECD_MAX 3940 //冲家巡航模式搜索角度最大值
#define SMALL_YAW_NAV_RUSH_HOME_ECD_MIN 3100 //冲家巡航模式搜索角度最小值
#define SMALL_YAW_NAV_RUSH_HOME_STEP 0.01 //冲家巡航模式下小yaw轴每次调整的角度步进，速度变小
...
#define PITCH_NAV_SEEK_ENEMY_ANGLE_MIN -19.0f 
#define PITCH_NAV_SEEK_ENEMY_STEP 0.08f 
#define PITCH_NAV_SEEK_OUTPOST_ANGLE_MAX 8.0f  
#define PITCH_NAV_SEEK_OUTPOST_ANGLE_MIN -3.0f
#define PITCH_NAV_SEEK_OUTPOST_STEP 0.08f
